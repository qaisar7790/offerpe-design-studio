...
import { initialAdminUsers, initialAffiliateNetworks, initialAppBuilds, initialApplications, initialCampaigns, initialCategories, initialClaims, initialCommunicationTemplates, initialMappings, initialOffers, initialPromoBanners, initialRejectionReasons, initialReviews, initialRoles, initialSyncRuns, legalPageSeeds, merchantStaffSeeds, merchants, onboardingSlideSeeds } from "@/data/mockData";
