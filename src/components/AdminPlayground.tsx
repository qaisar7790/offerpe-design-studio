...
export function AdminPlayground() {
  ...
  const content = view === "dashboard" ? <Dashboard chartData={chartData} />
    ...
    : view === "merchant-edit" && editingMerchant ? <MerchantEditPage rejectionReasons={rejectionReasons} merchant={editingMerchant} offers={offerRows} reviews={reviewRows} onApproveReview={approveReview} onRejectReview={rejectReview} onRevertReview={revertReview} onDeleteReview={deleteReview} initialTab={merchantTab} onBack={backToMerchants} onDeleteMerchant={deleteMerchant} onEditOffer={(offer) => openOffer(offer, { type: "merchant", merchant: editingMerchant })} onCreateOffer={() => openOffer(null, { type: "merchant", merchant: editingMerchant })} onDeleteOffer={deleteOffer} />
