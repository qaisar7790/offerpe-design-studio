...
function Merchants() {
  const [conversionRows, setConversionRows] = useState(conversions); const [query, setQuery] = useState(""); const [statuses, setStatuses] = useState<Status[]>([]); const [edit, setEdit] = useState<typeof merchants[number] | null>(null); const [sortAsc, setSortAsc] = useState(true);
