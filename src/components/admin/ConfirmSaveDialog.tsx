    ...
    <AlertDialog>
      ...
      <AlertDialogContent className="border-border bg-card">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            These values apply to every user immediately. Review the change before confirming.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <dl className="divide-y divide-border rounded-md border border-border bg-muted/30 text-sm">
          {summary.map((row) => (
