...
export const tabTriggerClass =
  "rounded-none border-b-2 border-transparent px-1 py-3 shadow-none data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:text-primary data-[state=active]:shadow-none";
...
export const affiliateMacroNote =
  "Recognized macros: {click_id} {user_id} {deeplink} {deeplink_encoded} {property_id} {tracking_url} {voucher_deeplink} {product_deeplink} {utm_params}. Also supports {URLENCODE}...{/URLENCODE} and [optional ...] blocks.";
