...
export function CitiesPage({ cityDirectory, cityStates, initialCities }: { readonly cityDirectory: Record<string, { name: string; lat: number; lng: number }[]>; readonly cityStates: string[]; readonly initialCities: CityRecord[] }) {
