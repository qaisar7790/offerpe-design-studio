...
export function ReviewsPage(props: { reviews: Review[]; merchantNames: string[]; rejectionReasons: readonly string[]; onApprove: (review: Review) => void; onReject: (review: Review, reason: string, note: string) => void; onRevert: (review: Review) => void; onDelete: (review: Review) => void }) {
