...
export function MerchantStaffDialog({ staff, merchantOptions, onSave, children }: { staff: MerchantStaff | null; merchantOptions: string[]; onSave: (staff: MerchantStaff, isNew: boolean) => void; children: React.ReactNode }) {
  const isNew = !staff;
