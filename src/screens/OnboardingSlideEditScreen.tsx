...
export function OnboardingSlidePreview({ slide, index, total }: { slide: OnboardingSlide; index: number; total: number }) {
...
export function OnboardingSlideEditPage({ slide, app, total, index, onCancel, onSave, onDelete }: { slide: OnboardingSlide | null; app: OnboardingApp; total: number; index: number; onCancel: () => void; onSave: (slide: OnboardingSlide) => void; onDelete: (slide: OnboardingSlide) => void }) {
  const isNew = !slide;
